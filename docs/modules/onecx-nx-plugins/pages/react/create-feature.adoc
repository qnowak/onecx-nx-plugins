...
Next steps may create components, services, and state management logic within the feature module as needed, e.g. xref:./create-search.adoc[create a React search page].
