...
In case you want to take part of the development of the generator or want to use it locally without installing it globally from npm, see the xref:angular/development.adoc[Development Guide] for instructions on how to get the generator and set up the development environment.

[IMPORTANT]
====
*Package renamed in version 9.* +
Starting with version *9.0.0-rc.2*, the Angular generator package has been renamed from `@onecx/nx-plugin` to `@onecx/angular-generator`. +
Update your generator commands accordingly, e.g. use `nx generate @onecx/angular-generator:feature ...` instead of `nx generate @onecx/nx-plugin:feature ...`. +
Older versions (v8 and below) continue to use the `@onecx/nx-plugin` package name.
====
...
* xref:angular/create-app.adoc[OneCX UI App] <= *start here*
** xref:angular/create-feature.adoc[Feature Module]
*** xref:angular/create-schema.adoc[Entity Schema and OpenAPI]
*** xref:angular/create-search.adoc[Search Component]
*** xref:angular/create-details.adoc[Details Component]
*** Create/Update Dialog
*** Delete Dialog
*** xref:angular/create-ngrx-page.adoc[Simple NgRx Page]
...
* xref:angular/create-feature.adoc[Create a Feature Module (React)] +
  Generates a feature entry page and registers feature-level routing.
* xref:angular/create-search.adoc[Create a React Search Page] +
  A data-driven search page with criteria, results table, header actions and API integration.
* xref:angular/create-details.adoc[Create a Detail Component (React)] +
  Generates details page, hook/store, and related UI components for a resource.
* xref:angular/create-page.adoc[Create a React Page] +
